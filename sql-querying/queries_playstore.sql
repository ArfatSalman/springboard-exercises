...
SELECT category, COUNT(app_name) AS App_Numbers FROM analytics GROUP BY category;
...
-- 8. Find all apps with a min install not exceeding 50, that have a rating. Order your sefults by highest rated first.
...
-- 10. Find the top 10 most-reviewed apps that cost betwwen 10 cents and a dollar.
...
-- 15. Find the app that has the highest proportion of min_installs to reviews, among apps that have been installed at least 
