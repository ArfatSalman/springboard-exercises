...
class Game {
  ...
  handleClick(evt) {
    ...
    if (this.checkForWin()) {
      this.gameOver = true;
      whoseTurn.innerText = `Player ${this.currPlayer} won!!!`
      whoseTurn.style.color = this.currPlayer.color;
    ...
    // update the turn player's text
    whoseTurn.innerText = `It is currently Player ${this.currPlayer.color}'s turn`;
    whoseTurn.style.color = this.currPlayer.color;
  }
